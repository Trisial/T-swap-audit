...
contract TSwapPool is ERC20 {
    ...
    /*//////////////////////////////////////////////////////////////
                                 EVENTS
    //////////////////////////////////////////////////////////////*/
    //@ audit-info 3 events should be indexed if more than 3 parameters
    ...
    function deposit(
        ...
        // @audit not being used
        // if someone set a deadline, in the next block, they could still deposit!!!
        uint64 deadline
    )
        external
        ...
        returns (uint256 liquidityTokensToMint)
    {
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            //@audit-info do not need this line
            ...
            // @audit maybe put it before the external call to follow CEI
    ...
    {
        //@audit-high different numbers making the fee different 10000 instead of 1000
    ...
    function sellPoolTokens(uint256 poolTokenAmount) external returns (uint256 wethAmount) {
        // @audit should be wethTokenAmount or swapExactInput it is wrong
